...
public:
	...
	* @param focus		焦距
	*/
	__host__ __device__ Camera(Vec3 lookfrom, Vec3 lookat, Vec3 vup, double vfov, double aspect, double aperture, double focus);
	...
	*/
	__host__ __device__ Ray GetRay(double u, double v) const;
